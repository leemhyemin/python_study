...
while num < 30:
    ...
    while num_input == True:
        ...
        elif num2[0].isdigit() == False or num2[1].isdigit() == False or num2[2].isdigit() == False:
            print("숫자를 입력하세요!")
        elif int(num2[0]) != num + 1:
            print(f"숫자를 {num+1} 부터 제대로 입력하세요!")
        elif len(num2) > 3:
            print("!! 3개까지 입력하세요!")
        elif len(num2) == 3 and (int(num2[0]) + 1 != int(num2[1]) or int(num2[1]) + 1 != int(num2[2])):
            print("순차적인 숫자를 입력하세요")
        elif len(num2) == 2 and int(num2[0]) + 1 != int(num2[1]):
            print("순차적인 숫자를 입력하세요")
        else:
...
print(f'{player_list[turn%player_num]} 패배!!! 후훗 잔넨  (쑻)(쑻)')
print('### 종료하시려면 Enter!~~')